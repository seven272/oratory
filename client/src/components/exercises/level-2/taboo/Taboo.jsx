...
import { tabooScenarios } from '../../../../assets/mocks/similarWords'
...
const Taboo = ({ alias, isDaily }) => {
  ...
  return (
    <div className={styles.main_taboo}>
      <h2 className={styles.title}>Словесное табу</h2>
      <p className={styles.descr}>
        Расскажи про предмет или явление не используя его и 3 ключевых
        слова
      </p>
