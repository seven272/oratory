...
const ScienceTranslator = ({ alias }) => {
  ...
  return (
    <div className={styles.main_science}>
      <h2 className={styles.title}>Просто о сложном</h2>
      <p className={styles.descr}>
        Опиши сложный термин максимально просто
      </p>
...
export default ScienceTranslator
