...
const FearExplosive = ({ alias }) => {
  ...
  return (
    <div className={styles.main_fear}>
      <h2 className={styles.title}>Громкий вызов</h2>
      <p className={styles.descr}>
        Уровень громкости должен максимально соответсвовать условию
        задания
      </p>
