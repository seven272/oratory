...
const ChallengeVerdict = ({ aiFeedback, isCompleted, reportText, onRetry }) => {
  ...
  return (
    <div className={styles.form_card}>
      ...
      <div className={isCompleted ? styles.feedback_success : styles.feedback_failed}>
